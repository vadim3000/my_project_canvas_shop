...
use App\Http\Middleware\RequestedRouteLoggingMiddleware;
use App\Http\Middleware\RequestResponseLoggingMiddleware;
use App\Http\Middleware\ResponseDataLoggingMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'response.log' => ResponseDataLoggingMiddleware::class,
    ];
}
